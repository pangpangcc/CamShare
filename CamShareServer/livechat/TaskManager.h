...
public:
	// 初始化接口
	virtual bool Init(const list<string>& svrIPs, unsigned int svrPort, ILiveChatClient* client, ILiveChatClientListener* clientListener, ITaskManagerListener* mgrListener);
	// 开始
	virtual bool Start();
	// 停止
	virtual bool Stop();

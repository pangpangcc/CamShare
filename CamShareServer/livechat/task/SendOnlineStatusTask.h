...
class SendOnlineStatusTask : public BaseTask
{
public:
	SendOnlineStatusTask(void);
	virtual ~SendOnlineStatusTask(void);
...
public:
	// 初始化参数
	bool InitParam(const string& userId, bool online);

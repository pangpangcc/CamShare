 ...
 * author: Samson.Fan
 *   date: 2015-04-01
 *   file: RecvDisconnectUserVideo.h
...
class RecvDisconnectUserVideo : public BaseTask
{
public:
	RecvDisconnectUserVideo(void);
	virtual ~RecvDisconnectUserVideo(void);

/*
 * RecvKickUserFromConferenceTask.h
...
class RecvKickUserFromConferenceTask : public BaseTask
{
public:
	RecvKickUserFromConferenceTask(void);
	virtual ~RecvKickUserFromConferenceTask(void);

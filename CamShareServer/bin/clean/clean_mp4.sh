...
# get date
clean_year=`date --date='6 months ago' +%Y`
clean_month=`date --date='6 months ago' +%m`
clean_day=`date --date='6 months ago' +%d`

# define mp4 path
mp4_path="/usr/local/freeswitch/recordings/video_mp4"
cd $mp4_path

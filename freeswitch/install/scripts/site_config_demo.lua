...
-- php接口路径
loginPaths = {
  ["0"] = "http://test:5179@demo.asiame.com/livechat/setstatus.php?action=getuserloginstatus",
  ["1"] = "http://test:5179@demo.asiame.com/livechat/setstatus.php?action=getuserloginstatus",
  ...
  ["7"] = "https://link:connect@demo.connectlink.com/s1db4v/chat/setStatus?action=getuserloginstatus"
};

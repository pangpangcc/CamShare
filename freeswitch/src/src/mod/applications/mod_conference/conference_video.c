...
//		conference_utils_set_flag(conference, CFLAG_VIDEO_MUXING);
		conference_utils_set_flag_locked(conference, CFLAG_VIDEO_MUXING);
...
//					conference_utils_set_flag(conference, CFLAG_VID_FLOOR_LOCK);
					conference_utils_set_flag_locked(conference, CFLAG_VID_FLOOR_LOCK);
				}

...
//		conference_utils_member_set_flag(member, MFLAG_INDICATE_MUTE);
		conference_utils_member_set_flag_locked(member, MFLAG_INDICATE_MUTE);
	}
	member->score_iir = 0;
...
//		conference_utils_member_set_flag(member, MFLAG_INDICATE_UNMUTE);
		conference_utils_member_set_flag_locked(member, MFLAG_INDICATE_UNMUTE);
	}
...
//			conference_utils_set_flag(conference, CFLAG_PERSONAL_CANVAS);
			conference_utils_set_flag_locked(conference, CFLAG_PERSONAL_CANVAS);
		} else {
...
//					conference_utils_set_flag(conference, CFLAG_REFRESH_LAYOUT);
					conference_utils_set_flag_locked(conference, CFLAG_REFRESH_LAYOUT);
					return SWITCH_STATUS_SUCCESS;
				} else {
...
//				conference_utils_member_set_flag(other_member, MFLAG_RECEIVING_VIDEO);
				conference_utils_member_set_flag_locked(other_member, MFLAG_RECEIVING_VIDEO);
				switch_core_session_request_video_refresh(member->session);
			}

...
#include <camshare/CamshareClient.h>
...
class CamshareClientListenerImp : public CamshareClientListener {
	...
	void OnCallVideo(CamshareClient* client, const unsigned char* data, unsigned int width, unsigned int height, unsigned int time) {
		FileLog("CamshareClient",

...
sudo yum install -y gcc-c++ gdb autoconf automake libtool wget python ncurses-devel zlib-devel openssl-devel e2fsprogs-devel sqlite-devel libcurl-devel pcre-devel speex-devel ldns-devel libedit-devel libxml2-devel opus-devel libidn-devel unbound-devel libuuid-devel lua-devel libsndfile-devel
